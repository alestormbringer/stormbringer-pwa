...
export default function CampaignForm({ onSubmit, onCancel, loading = false }: CampaignFormProps) {
  ...
  const [fileInputs, setFileInputs] = useState<string[]>(['']); // Per gestire più input di file
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold text-yellow-500 mb-6">Crea Nuova Campagna</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            value={formData.nextSessionDate ? new Date(formData.nextSessionDate.getTime() - formData.nextSessionDate.getTimezoneOffset() * 60000).toISOString().slice(0, 16) : ''}
